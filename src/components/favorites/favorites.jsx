...
function FavoritesPage() {
    ...
    return (
        ...
        <div className="container my-5 mt-5 ">
            <h2 className="mb-4  mt-5 text-center">favorites filmes ❤️ </h2>
            
            {/* في حال كانت القائمة فارغة */}
            {favoritsList.length === 0 ? (
                <div className="text-center my-5 py-5">
                    <p className="fs-4 text-muted">قائمة المفضلة لديك فارغة حالياً.</p>
                    <Link to="/" className="btn btn-primary mt-3">تصفح الأفلام الآن</Link>
                </div>
            ) : (
